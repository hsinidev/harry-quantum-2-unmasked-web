<div align="center">
  ...
  <img src="https://capsule-render.vercel.app/api?type=waving&color=gradient&customColorList=0,2,2,5,30&height=180&section=header&text=Harry%20Quantum%202%20Unmasked&fontSize=42&fontColor=fff&animation=fadeIn&fontAlignY=38" width="100%" style="max-width: 100%; border-radius: 12px; margin-bottom: 20px;" alt="Harry Quantum 2 Unmasked Web Header Banner" />

  <h1>🚀 Harry Quantum 2 Unmasked Web</h1>
  ...
  <p align="center">
    ...
    <a href="https://github.com/hsinidev/harry-quantum-2-unmasked-web"><img src="https://img.shields.io/badge/License-MIT-green?style=for-the-badge" alt="License: MIT" /></a>
  </p>
...
**Harry Quantum 2 Unmasked Web** delivers a fast, responsive, and cross-platform browser experience built with **JavaScript** and hardware-accelerated canvas rendering.
...
```bash
git clone https://github.com/hsinidev/harry-quantum-2-unmasked-web.git
cd harry-quantum-2-unmasked-web
```
